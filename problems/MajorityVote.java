 ...
 * more occurrences than all the others, and if so, to determine this choice.
 * Mathematically, given a finite sequence (length n) of numbers, the object is
 * to find the majority number defined as the number that appears more than
 * ⌊ n/2 ⌋ times.
 */
