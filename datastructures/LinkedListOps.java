...
public class LinkedListOps {
  public static void main(String[] args) throws IOException {
    ...
    int x, y;
    switch (option) {
      case 1: list.reverseByRec(list.head);
              System.out.print("\nReversed: ");
              list.print();
              break;
      case 2: System.out.print("Remove? ");
              ...
              list.print();
              break;
      case 3: System.out.print("Remove all? ");
              x = Integer.parseInt(in.readLine());
              node = new SinglyLinkedList.Node(x);
              list.removeAll(node);
              System.out.print("List: ");
              list.print();
              break;
      case 4: int size = list.lengthByRec(list.head);
              System.out.print("Length: " + size);
              break;
      case 5: System.out.println("Swap? Which 2?");
              x = Integer.parseInt(in.readLine());
              y = Integer.parseInt(in.readLine());
              list.swap(new SinglyLinkedList.Node(x),
                new SinglyLinkedList.Node(y));
              System.out.print("List: ");
              list.print();
              break;
      case 6: System.out.println("Merge two lists? Enter 2nd list " +
                "length and the list");
